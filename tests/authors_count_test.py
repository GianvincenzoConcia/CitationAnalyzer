...
class TestYourModule(unittest.TestCase):
    ...
    def test_get_author_usage(self):
        ...
        with unittest.mock.patch('authors_count.search_conference', search_conference):
            with unittest.mock.patch('authors_count.get_year_element', get_year_element):
                with unittest.mock.patch('authors_count.get_contents_link', get_contents_link):
                    with unittest.mock.patch('authors_count.get_block_elements', get_block_elements):
